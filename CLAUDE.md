...
- `upgrade.py` — Template versioning and upgrade logic: version comparison, prompt-section diffing, and apply-upgrade for WORKFLOW.md and REVIEW.md. Both canonical templates live in `templates/` with `template_version` in YAML front matter.
